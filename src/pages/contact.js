        ...
        <div>
            <Layout>
                ...
                <div className={contactStyles.contact}>
                    <a className={contactStyles.box} href="mailto:changyang629@gmail.com"><p className={contactStyles.text}>Message me</p></a>
                    <div className="LI-profile-badge" data-version="v1" data-size="medium" data-locale="en_US"
                        ...
                        className="LI-simple-link" href='https://se.linkedin.com/in/changyangzhang?trk=profile-badge'>Changyang
                        Z.</a></div>
                </div>
            </Layout>
        </div>
